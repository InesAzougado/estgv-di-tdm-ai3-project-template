...
/* harmony import */ var _configuration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./configuration */ "./src/app/api-client/configuration.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _api_account_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./api/account.service */ "./src/app/api-client/api/account.service.ts");
/* harmony import */ var _api_communication_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./api/communication.service */ "./src/app/api-client/api/communication.service.ts");
/* harmony import */ var _api_support_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./api/support.service */ "./src/app/api-client/api/support.service.ts");
var ApiModule_1;
...
ApiModule = ApiModule_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        exports: [],
        providers: [
            _api_account_service__WEBPACK_IMPORTED_MODULE_4__["AccountService"],
            _api_communication_service__WEBPACK_IMPORTED_MODULE_5__["CommunicationService"],
            _api_support_service__WEBPACK_IMPORTED_MODULE_6__["SupportService"]
        ]
    }),
...
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../variables */ "./src/app/api-client/variables.ts");
/* harmony import */ var _configuration__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../configuration */ "./src/app/api-client/configuration.ts");
/**
...
let AccountService = class AccountService {
    ...
    accountChangePasswordPost(body, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.request('post', `${this.basePath}/account/change_password`, {
            body: body,
    ...
    accountLoginPost(body, observe = 'body', reportProgress = false) {
        if (body === null || body === undefined) {
        ...
        return this.httpClient.request('post', `${this.basePath}/account/login`, {
            body: body,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    accountLogoutGet(observe = 'body', reportProgress = false) {
        let headers = this.defaultHeaders;
        ...
        // to determine the Content-Type header
        const consumes = [];
        return this.httpClient.request('get', `${this.basePath}/account/logout`, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
    ...
    accountPreferencesPut(body, observe = 'body', reportProgress = false) {
        if (body === null || body === undefined) {
        ...
        return this.httpClient.request('put', `${this.basePath}/account/preferences`, {
            body: body,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    accountRegisterPost(body, observe = 'body', reportProgress = false) {
        if (body === null || body === undefined) {
        ...
        return this.httpClient.request('post', `${this.basePath}/account/register`, {
            body: body,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    accountsProfileGet(observe = 'body', reportProgress = false) {
        let headers = this.defaultHeaders;
        // authentication (auth0) required
        if (this.configuration.accessToken) {
            const accessToken = typeof this.configuration.accessToken === 'function'
        ...
        // to determine the Content-Type header
        const consumes = [];
        return this.httpClient.request('get', `${this.basePath}/accounts/profile`, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
...
let CommunicationService = class CommunicationService {
    ...
    communicationSendEmailPost(body, observe = 'body', reportProgress = false) {
        if (body === null || body === undefined) {
        ...
        return this.httpClient.request('post', `${this.basePath}/communication/send_email`, {
            body: body,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
...
let SupportService = class SupportService {
    ...
    supportTicketPost(body, observe = 'body', reportProgress = false) {
        if (body === null || body === undefined) {
        ...
        return this.httpClient.request('post', `${this.basePath}/support/ticket`, {
            body: body,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
...
/* harmony import */ var _contactos_contactos_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./contactos/contactos.component */ "./src/app/contactos/contactos.component.ts");
/* harmony import */ var _registar_registar_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./registar/registar.component */ "./src/app/registar/registar.component.ts");
/* harmony import */ var _enviar_mensagem_enviar_mensagem_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./enviar-mensagem/enviar-mensagem.component */ "./src/app/enviar-mensagem/enviar-mensagem.component.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buildApiConfiguration", function() { return buildApiConfiguration; });
...
/* harmony import */ var _api_client_api_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./api-client/api.module */ "./src/app/api-client/api.module.ts");
/* harmony import */ var _api_client_configuration__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./api-client/configuration */ "./src/app/api-client/configuration.ts");
...
/* harmony import */ var _material_layout_material_layout_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./material-layout/material-layout.component */ "./src/app/material-layout/material-layout.component.ts");
/* harmony import */ var _nav_bar_nav_bar_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./nav-bar/nav-bar.component */ "./src/app/nav-bar/nav-bar.component.ts");
...
/* harmony import */ var _registar_registar_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./registar/registar.component */ "./src/app/registar/registar.component.ts");
/* harmony import */ var _contactos_contactos_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./contactos/contactos.component */ "./src/app/contactos/contactos.component.ts");
/* harmony import */ var _enviar_mensagem_enviar_mensagem_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./enviar-mensagem/enviar-mensagem.component */ "./src/app/enviar-mensagem/enviar-mensagem.component.ts");
...
/* harmony import */ var ng_recaptcha__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ng-recaptcha */ "./node_modules/ng-recaptcha/fesm2015/ng-recaptcha.js");
...
/* harmony import */ var ngx_push_notifications__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ngx-push-notifications */ "./node_modules/ngx-push-notifications/fesm2015/ngx-push-notifications.js");
...
function buildApiConfiguration() {
    ...
    const config = new _api_client_configuration__WEBPACK_IMPORTED_MODULE_17__["Configuration"](configurationParameters);
    return config;
}
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        declarations: [
            ...
            _material_layout_material_layout_component__WEBPACK_IMPORTED_MODULE_20__["MaterialLayoutComponent"],
            _nav_bar_nav_bar_component__WEBPACK_IMPORTED_MODULE_21__["NavBarComponent"],
            ...
            _registar_registar_component__WEBPACK_IMPORTED_MODULE_25__["RegistarComponent"],
            _contactos_contactos_component__WEBPACK_IMPORTED_MODULE_26__["ContactosComponent"],
            _enviar_mensagem_enviar_mensagem_component__WEBPACK_IMPORTED_MODULE_27__["EnviarMensagemComponent"],
        ],
        imports: [
            ...
            ng_recaptcha__WEBPACK_IMPORTED_MODULE_29__["RecaptchaModule"].forRoot(),
            _api_client_api_module__WEBPACK_IMPORTED_MODULE_16__["ApiModule"].forRoot(buildApiConfiguration),
            _angular_forms__WEBPACK_IMPORTED_MODULE_28__["FormsModule"],
            ng_recaptcha__WEBPACK_IMPORTED_MODULE_29__["RecaptchaModule"],
            ng_recaptcha__WEBPACK_IMPORTED_MODULE_29__["RecaptchaFormsModule"],
            _angular_service_worker__WEBPACK_IMPORTED_MODULE_30__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].production }),
        ],
        providers: [{
...
/* harmony import */ var _api_client_api_support_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../api-client/api/support.service */ "./src/app/api-client/api/support.service.ts");
/* harmony import */ var ngx_push_notifications__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-push-notifications */ "./node_modules/ngx-push-notifications/fesm2015/ngx-push-notifications.js");
...
let ContactosComponent = class ContactosComponent {
    constructor(auth, httpClient, formBuilder, userService, supportservice, _pushNotificationService) {
        this.auth = auth;
        this.httpClient = httpClient;
    ...
    showNoti() {
        ...
        const options = new ngx_push_notifications__WEBPACK_IMPORTED_MODULE_7__["PushNotificationOptions"]();
    ...
    doSupport() {
        const sendmail = this.supportForm.value;
...
ContactosComponent.ctorParameters = () => [
    { type: _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EnviarMensagemComponent", function() { return EnviarMensagemComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../auth.service */ "./src/app/auth.service.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/user.service */ "./src/app/services/user.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _api_client_api_communication_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../api-client/api/communication.service */ "./src/app/api-client/api/communication.service.ts");
/* harmony import */ var ngx_push_notifications__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-push-notifications */ "./node_modules/ngx-push-notifications/fesm2015/ngx-push-notifications.js");
...
let EnviarMensagemComponent = class EnviarMensagemComponent {
    constructor(auth, httpClient, formBuilder, userService, comunicationservice, _pushNotificationService) {
        this.auth = auth;
        this.httpClient = httpClient;
        this.formBuilder = formBuilder;
        this.userService = userService;
    ...
    doSupport() {
        const sendmail = this.userForm.value;
        console.log(sendmail);
...
EnviarMensagemComponent.ctorParameters = () => [
    { type: _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] },
...
EnviarMensagemComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-enviar-mensagem',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./enviar-mensagem.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/enviar-mensagem/enviar-mensagem.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./enviar-mensagem.component.scss */ "./src/app/enviar-mensagem/enviar-mensagem.component.scss")).default]
    })
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var ngx_push_notifications__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-push-notifications */ "./node_modules/ngx-push-notifications/fesm2015/ngx-push-notifications.js");



let HomeComponent = class HomeComponent {
    constructor(_pushNotificationService) {
        this._pushNotificationService = _pushNotificationService;
    }
    ngOnInit() {
        this._pushNotificationService.requestPermission();
    ...
    showNoti() {
        ...
        const options = new ngx_push_notifications__WEBPACK_IMPORTED_MODULE_2__["PushNotificationOptions"]();
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _api_client_api_account_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../api-client/api/account.service */ "./src/app/api-client/api/account.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var ngx_push_notifications__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-push-notifications */ "./node_modules/ngx-push-notifications/fesm2015/ngx-push-notifications.js");
...
let LoginComponent = class LoginComponent {
     ...
     */
    constructor(accountService, formBuilder, //Servisso a que vamos recorrer no servidor
    ...
    showNoti() {
        const title = 'Bem vindo à página Login!';
        const options = new ngx_push_notifications__WEBPACK_IMPORTED_MODULE_4__["PushNotificationOptions"]();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialLayoutComponent", function() { return MaterialLayoutComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let MaterialLayoutComponent = class MaterialLayoutComponent {
...
MaterialLayoutComponent.ctorParameters = () => [
    { type: _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_2__["BreakpointObserver"] }
];
MaterialLayoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-material-layout',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./material-layout.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/material-layout/material-layout.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./material-layout.component.scss */ "./src/app/material-layout/material-layout.component.scss")).default]
    })
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../auth.service */ "./src/app/auth.service.ts");
/* harmony import */ var ngx_push_notifications__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-push-notifications */ "./node_modules/ngx-push-notifications/fesm2015/ngx-push-notifications.js");




let NavBarComponent = class NavBarComponent {
    constructor(auth, _pushNotificationService) {
        this.auth = auth;
        this._pushNotificationService = _pushNotificationService;
    }
    ngOnInit() {
    ...
    showNoti() {
        ...
        const options = new ngx_push_notifications__WEBPACK_IMPORTED_MODULE_3__["PushNotificationOptions"]();
...
let RegistarComponent = class RegistarComponent {
    constructor(auth, httpClient, formBuilder, userService, comunicationservice, _pushNotificationService) {
        this.auth = auth;
        this.httpClient = httpClient;
        this.formBuilder = formBuilder;
...
RegistarComponent.ctorParameters = () => [
    { type: _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] },
...
RegistarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-registar',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./registar.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/registar/registar.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./registar.component.scss */ "./src/app/registar/registar.component.scss")).default]
    })
], RegistarComponent);
...
let UserApiService = class UserApiService {
     ...
     */
    buildApiUrl(config) {
        let finalResourceUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiBaseUrl}`;
        if (config && config.path) {
            finalResourceUrl = `${finalResourceUrl}/${config.path}`;
        }
        return config && config.queryParams
            ? `${finalResourceUrl}?${query_string__WEBPACK_IMPORTED_MODULE_1__["stringify"](config.queryParams)}`
            : finalResourceUrl;
    }
    createUser(data) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserFakeService", function() { return UserFakeService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var random_int__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! random-int */ "./node_modules/random-int/index.js");
/* harmony import */ var random_int__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(random_int__WEBPACK_IMPORTED_MODULE_1__);
...
let UserFakeService = class UserFakeService {
    /** @inheritdoc */
    getUserById(userId) {
        const user = DATA.find(existingUser => existingUser.id === userId);
        return user
            ? Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(user)
            : Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])({ message: `User not found. id=${userId}` });
    }
    /** @inheritdoc */
    listUsers(filter) {
        let results = DATA;
    ...
    updateUserById(userId, data) {
        const user = DATA.find(existingUser => existingUser.id === userId);
        if (!user) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])({ message: `User not found. id=${userId}` });
        }
        if (data.name) {
            user.name = data.name;
        }
...
UserFakeService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buildUserService", function() { return buildUserService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../environments/environment */ "./src/environments/environment.ts");
/* harmony import */ var _api_user_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./api/user-api.service */ "./src/app/services/api/user-api.service.ts");
/* harmony import */ var _fake_user_fake_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./fake/user-fake.service */ "./src/app/services/fake/user-fake.service.ts");
...
module.exports = __webpack_require__(/*! /Users/inesazougado/Documents/GitHub/estgv-di-tdm-ai3-project-template/client/src/main.ts */"./src/main.ts");
